...
def main():
    ...
    fills_path = ARTIFACTS_DIR / "fills_equal_weight_weekly.csv"
    equity_path = ARTIFACTS_DIR / "equity_equal_weight_weekly.csv"
    pos_path = ARTIFACTS_DIR / "positions_equal_weight_weekly.csv"
